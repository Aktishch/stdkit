...
export const FormLabel = forwardRef(FormLabelComponent) as React.ForwardRefExoticComponent<
  FormLabelProps & React.RefAttributes<HTMLLabelElement>
>

export const FormWrapper = forwardRef(FormWrapperComponent) as React.ForwardRefExoticComponent<
  FormWrapperProps & React.RefAttributes<HTMLDivElement>
>

export const FormIcon = forwardRef(FormIconComponent) as React.ForwardRefExoticComponent<
  FormIconProps & React.RefAttributes<HTMLDivElement>
>

export const FormError = forwardRef(FormErrorComponent) as React.ForwardRefExoticComponent<
